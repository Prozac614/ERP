...
export const JeecgListMixin = {
  ...
  methods: {
    loadData(arg) {
      console.log('loadData called with arg:', arg);
      if (!this.url.list) {
      ...
      console.log('Current queryParam:', this.queryParam);
      let params = this.getQueryParams() //查询条件
      console.log('Final request params:', params);
      console.log('Query params:', params)
      console.log('Raw queryParam:', this.queryParam)
      console.log('Stringified search:', params.search)
      this.loading = true
      console.log('Making request to:', this.url.list);
    ...
    getQueryParams() {
      ...
      let searchObj = {}
      console.log('Query param before stringify:', this.queryParam);
      // 确保 shopName 不为空字符串或 undefined
      if (this.queryParam.shopName === '' || this.queryParam.shopName === undefined) {
        delete this.queryParam.shopName;
      }
      searchObj.search = JSON.stringify(this.queryParam);
      console.log('Search string after stringify:', searchObj.search);
