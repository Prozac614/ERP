...
public class ExceptionConstants {
    ...
    public static final String MATERIAL_SERIAL_NUMBERE_EMPTY_MSG = "抱歉，商品唛头:%s的序列号不能为空";
    // 商品库存不足
    ...
    public static final String MATERIAL_BARCODE_EXISTS_MSG = "商品唛头:%s重复";
    // 商品-单位匹配不上
    public static final int MATERIAL_UNIT_MATE_CODE = 8000006;
    public static final String MATERIAL_UNIT_MATE_MSG = "抱歉，商品唛头:%s的单位匹配不上，请完善多单位信息！";
    // 商品唛头长度应该为2到40位
    public static final int MATERIAL_BARCODE_LENGTH_ERROR_CODE = 8000007;
    public static final String MATERIAL_BARCODE_LENGTH_ERROR_MSG = "商品唛头:%s的长度应该为2到40位";
    // 序列号和批号只能有一项
    public static final int MATERIAL_ENABLE_MUST_ONE_CODE = 8000008;
    public static final String MATERIAL_ENABLE_MUST_ONE_MSG = "抱歉，商品唛头:%s的序列号和批号不能同时填1";
    // 抱歉，文件扩展名必须为xls
    ...
    public static final String MATERIAL_EXCEL_IMPORT_BARCODE_EXIST_MSG = "抱歉，EXCEL中存在重复的唛头，具体唛头为：%s";
    // 名称长度超出
    ...
    public static final String MATERIAL_BARCODE_IS_NOT_EXIST_MSG = "商品唛头%s不存在，请重新选择";
    // 基本唛头为空
    public static final int MATERIAL_BARCODE_EMPTY_CODE = 8000027;
    public static final String MATERIAL_BARCODE_EMPTY_MSG = "第%s行基本唛头为空";
    // EXCEL中有副唛头在系统中已存在（除自身商品之外）
    public static final int MATERIAL_EXCEL_IMPORT_MANY_BARCODE_EXIST_CODE = 80000028;
    public static final String MATERIAL_EXCEL_IMPORT_MANY_BARCODE_EXIST_MSG = "抱歉，EXCEL中有副唛头在系统中已存在，具体副唛头为：%s";
    // 单次导出条数超出限制（1万条）
    ...
    // 单据录入-商品唛头XXX的数量需要修改下
    public static final int DEPOT_HEAD_NUMBER_NEED_EDIT_FAILED_CODE = 85000014;
    public static final String DEPOT_HEAD_NUMBER_NEED_EDIT_FAILED_MSG = "商品唛头%s的数量需要修改下";
    // 单据录入-商品的批号不能为空
    public static final int DEPOT_HEAD_BATCH_NUMBERE_EMPTY_CODE = 8500015;
    public static final String DEPOT_HEAD_BATCH_NUMBERE_EMPTY_MSG = "抱歉，商品唛头:%s的批号不能为空";
    // 单据录入-会员预付款余额不足
    ...
    // 单据录入-商品唛头XXX的数量与序列号不一致
    public static final int DEPOT_HEAD_SN_NUMBERE_FAILED_CODE = 8500021;
    public static final String DEPOT_HEAD_SN_NUMBERE_FAILED_MSG = "抱歉，商品唛头:%s的数量与序列号不一致";
    // 单据录入-单据编号已经存在
    ...
    public static final String DEPOT_ITEM_BARCODE_IS_NOT_EXIST_MSG = "抱歉，商品唛头:%s在商品管理中不存在";
    // 单据明细-明细中仓库不存在
